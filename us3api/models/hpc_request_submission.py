...
class HPCRequestSubmission(BaseModel):
    """
    HPCRequestSubmission
    """ # noqa: E501
    success: StrictStr
    hp_crequest_ids: List[StrictInt] = Field(description="The IDs of the HPC requests that were submitted", alias="HPCrequestIDs")
    results: List[StrictStr] = Field(description="The results/errors of the submission(s)")
    __properties: ClassVar[List[str]] = ["success", "HPCrequestIDs", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "HPCrequestIDs": obj.get("HPCrequestIDs"),
