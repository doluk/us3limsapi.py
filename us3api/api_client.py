...
from us3api.api_response import ApiResponse, T as ApiResponseT
import us3api.models
from us3api import rest
from us3api.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(us3api.models, klass)
