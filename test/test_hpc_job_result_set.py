...
class TestHPCJobResultSet(unittest.TestCase):
    """HPCJobResultSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HPCJobResultSet:
        """Test HPCJobResultSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HPCJobResultSet`

        if include_optional:
            return HPCJobResultSet(
                result_id = 56,
                result_type = 'model'
            )
        else:
