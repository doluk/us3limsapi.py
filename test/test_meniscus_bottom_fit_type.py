...
class TestMeniscusBottomFitType(unittest.TestCase):
    """MeniscusBottomFitType unit test stubs"""
    ...
    def testMeniscusBottomFitType(self):
        """Test MeniscusBottomFitType"""
        inst = MeniscusBottomFitType()
